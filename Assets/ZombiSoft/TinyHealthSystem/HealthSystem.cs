...
public class HealthSystem : MonoBehaviour
{
    ...
    //==============================================================
    // Damage on T key press
    //==============================================================
    public float damageOnT = 10f; // Количество урона при нажатии T
    ...
    void Update()
    {
        ...
        // Проверка нажатия клавиши T для получения урона
    ...
    {
        if (GodMode) return; // Если включен GodMode, игрок не получает урон
    ...
    IEnumerator PlayerHurts()
    {
        ...
        // Проверяем, существует ли PopupText перед использованием
        ...
        {
            Debug.Log("Ouch! -10 HP"); // Альтернативное сообщение в консоль
        }
    ...
    IEnumerator PlayerDied()
    {
        ...
        {
            Debug.Log("You have died!"); // Альтернативное сообщение в консоль
        }
